...
# Route Table for public subnet to route to Internet Gateway
...
# Risky Security Group with open port 22
...
# EC2 Instance in public subnet using risky security group
